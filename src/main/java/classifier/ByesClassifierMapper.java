...
public class ByesClassifierMapper extends Mapper<Text, Text, Text, IntWritable> {
	...
	private static final Logger log = LoggerFactory.getLogger(ByesClassifierMapper.class);
	 enum Counter {
			FAILDOCS
		}
	/**
